        ...
        ?>
            <div class="section-item ad clearfix banner-form" id="<?php echo esc_attr($ads_item['slug']); ?>">
                 <form name="<?php echo esc_attr($ads_item['slug']); ?>" class="no-submit no-dependency-checkboxes">
                    ...
                    <?php
                    $ad_data = magellan_gs($ads_item['slug']);
                    ?>
                    <div class="ad-items">
                        <?php 
                        if(!empty($ad_data)) 
                        {   
                            foreach($ad_data as $key => $ad_item)
                            {
                                    ...
                                    $ad_item['ad_type'] == 'banner')
                                {
                                    ...
                                    {
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:0']); ?>"><img src="<?php echo esc_url(magellan_banner_image_src($ad_item['ad_file:0'])); ?>" alt="" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:1']); ?>"><img src="<?php echo esc_url(magellan_banner_image_src($ad_item['ad_file:1'])); ?>" alt="" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:2']); ?>"><img src="<?php echo esc_url(magellan_banner_image_src($ad_item['ad_file:2'])); ?>" alt="" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:3']); ?>"><img src="<?php echo esc_url(magellan_banner_image_src($ad_item['ad_file:3'])); ?>" alt="" /></a><?php
                                    }
                                    else
                                    {
										magellan_banner_image_src($ad_item['ad_file']);
										?><a href="<?php echo esc_url($ad_item['ad_link']); ?>"><img src="<?php echo esc_url(magellan_banner_image_src($ad_item['ad_file'])); ?>" alt="" /></a><?php
                                    }
    ...
    ?>
        ...
        jQuery(document).ready(function () {
            ...
            jQuery('#save').click(function(){
                ...
                var nonce = '<?php echo wp_create_nonce('magellan_save_ads') ?>';
                var data = { action: 'magellan_save_ads', _ajax_nonce: nonce, data: ''};        
                var results = '';
