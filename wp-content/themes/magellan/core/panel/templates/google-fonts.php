<?php
	...
	//custom added fonts
	$extra_fonts = get_option('magellan_extra_google_fonts', array());
?>
<div class="section-item clearfix google-fonts">
	
	<div class="all-fonts">
		<h3><?php esc_html_e('All Google fonts', 'magellan'); ?></h3>
	...
	<div class="active-fonts">
		<h3><?php esc_html_e('Selected', 'magellan'); ?></h3>
		<div class="font-list">
			<?php 
	...
	<div class="default-fonts">
		<h3><?php esc_html_e('Default', 'magellan'); ?></h3>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
		...
		jQuery('.font-item .move-font').click(function(){
            ...
            var nonce = '<?php echo wp_create_nonce('magellan_extra_google_fonts') ?>';
            var data = { action: 'magellan_extra_google_fonts', _ajax_nonce: nonce, data: result};
