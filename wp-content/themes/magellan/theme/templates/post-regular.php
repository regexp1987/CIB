...
if($post_image_width == 'full_screen')
{
	...
	$outer_wrapper_class = 'container main-content-wrapper hentry post-main-wrapper featured sidebar-' . magellan_get_sidebar_position();
	$inner_wrapper_class = 'main-content hentry';
}
else
{
	$outer_wrapper_class = 'container main-content-wrapper post-main-wrapper sidebar-' . magellan_get_sidebar_position();
	$inner_wrapper_class = 'main-content hentry';
	$affix_wrapper_open = '';
	$affix_wrapper_close = '';
}
