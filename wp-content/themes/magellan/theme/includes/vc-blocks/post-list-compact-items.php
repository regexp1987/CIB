...
{
	class Magellan_Post_List_compact_items extends Magellan_VC_Block_Base {

		public $shortcode = 'post_list_compact_items';
		public $classname = 'Magellan_Post_List_compact_items';	//for 5.2 compatibility.
		...
		public function getParams() {
			...
			return array(
				'name'				=> esc_html__('Post list with large items (text on side)', 'magellan'),
				'description'		=> esc_html__('Blog like post list with large items that have text on side. 1/3 to 2/3 width recommended', 'magellan'),
	...
	new Magellan_Post_List_compact_items();
