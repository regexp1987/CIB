...
{
	class Magellan_Banner970 extends Magellan_VC_Block_Base {

		public $shortcode = 'magellan_banner_970';
		public $classname = 'Magellan_Banner970';	//for 5.2 compatibility.
		...
		public function getParams() {
			...
			//banners 970x90
			$banners_970x90_data = magellan_get_active_banners('970x90');
			...
			return array(
				"name" => esc_html__("Banner 970x90", 'magellan'),
				"base" => "magellan_banner_970",
				"class" => "",
				...
				"params" => array(
					array(
						 ...
						 "description" => esc_html__("Display 970x90 banners. Check more than one to have multiple banners in rotation", 'magellan')
					),
				)  
			);	
		}
		...
		public static function shortcode($atts = array(), $content = '') {
			...
			if(!empty($banner))
			{
				...
				$banner_data = magellan_get_banner_by_size_and_slug($banner_id, '970x90');
